                                ...
                                <div class="auth-form">
                                    ...
                                    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="teacher_email" class="form-control" placeholder="Enter Your Email">
                                        </div>
                                        <div class="text-center">
                                            <button type="submit" name="teacher_email_submit_btn" class="btn btn-primary btn-block">SUBMIT</button>
                                        </div>
                                    </form>
                                </div>
                            </div>

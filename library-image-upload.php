...
if (!isset($_SESSION['library_insert_check']) || $_SESSION['library_insert_check'] !== true) {
...
$library_title = $_SESSION['library_insert_title'];
				...
				if (file_exists($file_dir . $hash_image_exact)) {
					...
					if ($file_size > 1000000) {
						...
						if (in_array($file_extension_lower_case, $image_array)) {
							...
							$query = "UPDATE `library` SET `image` = '$hash_image_exact' WHERE `title` = '$library_title' ";

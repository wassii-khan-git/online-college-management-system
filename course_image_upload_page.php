...
if(!isset($_SESSION['course_insert_check']) || $_SESSION['course_insert_check'] !== true){
...
require_once "./php/config.php";
 ...
 $course_code = $_SESSION['course_insert_course_code'];
				...
				if (file_exists($file_dir . $hash_image_exact)) {
					...
					if ($file_size > 1000000) {
						...
						if (in_array($file_extension_lower_case, $image_array)) {
							...
							$query = "UPDATE `courses` SET `image` = '$hash_image_exact' WHERE `course_code` = '$course_code' ";
							...
							if ($result) {
								...
								if (isset($_SESSION['logged']) && $_SESSION['logged'] === true) {
									...
									'
									 ;
								} else if(isset($_SESSION['teacher_logged']) && $_SESSION['teacher_logged'] === true) {
									echo
									'
										<script>
									
											setTimeout(function(){
												window.location.href="all-courses-teacher.php";
											} , 1000);
				...
				<div class="row page-titles mx-0">
					...
					<div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a href="javascript:void(0);">Add Course Image</a></li>

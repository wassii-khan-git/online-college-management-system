															...
															<tr>
																...
																<td>
																	<form action="all-students.php" method="post">
																		...
																		<button type="submit" name="edit_btn" class="btn btn-primary"><i class="la la-pencil"></i></button>
												...
												<div class="card card-profile mt-2 ">
														...
														<div class="dropdown">
															...
															<div class="dropdown-menu dropdown-menu-right border py-0">
																<div class="py-2">
																	...
																	<form action="all-students.php" method="post">
																		<input type="hidden" name="hidden_edit_grid_box" value="<?php echo $fetch_record['id']; ?>">
													...
													<div class="card-body ">
														<div class="text-center">
															...
															<form action="all-students.php" method="post">
																<input type="hidden" name="hidden_profile_grid_box" value="<?php echo $fetch_record['id']; ?>">
																<button type="submit" class="btn btn-outline-primary btn-rounded mt-3 px-4" name="profile_grid_btn">Read More</button>
															</form>

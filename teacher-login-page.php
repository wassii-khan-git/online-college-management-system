...
include("./admin/teacher-login.php");
// session_start();
                ...
                <div class="col-md-6">
                    <div class="authincation-content">
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form" id="auth-form-id">

                                    <h2 class="text-center mb-5" style="font-weight: bold;">Professor Login</h2>
                                    ...
                                    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="password" type="password" name="password" value="<?php if (isset($password)) echo $password ?>" class="form-control" required>

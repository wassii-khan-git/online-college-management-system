												...
												<tbody>
													...
													?>
															<tr>
																...
																<td><?php echo $fetch_record['course_duration'] ?></td>
																<td><?php echo $fetch_record['course_price'] ?></td>
																<td><?php echo $fetch_record['professor_name'] ?></td>
																<td><a href="javascript:void(0);"><strong><?php echo $fetch_record['maximum_students'] ?></strong></a></td>

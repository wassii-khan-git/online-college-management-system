...
$edit_id = $_SESSION['edit_student_box_value'];
...
if ($row > 0) {
    while ($fetch_record = mysqli_fetch_assoc($retrieve_query_result)) {
        ...
        $fetched_roll_no = mysqli_real_escape_string($con, $fetch_record['roll_no']);
            ...
            if (strlen($_POST['parents_mobile_number']) > 11) {
                ...
                if (isset($_FILES['image']) && empty($_FILES['image']['name'])) {
                    ...
                    $update_query = "UPDATE `students` SET `firstname` = '$first_name', `lastname` = '$last_name',
        			 `registration_date` = '$registration_date', `roll_no` = '$roll_no' , `class` = '$class',
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="roll_no" class="form-control <?php if ($roll_no_alert) echo 'is-invalid' ?>" value="<?php echo $fetched_roll_no ?>">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <input type="submit" name="student_update_btn" class="btn btn-primary" value="Update">
                                        </div>

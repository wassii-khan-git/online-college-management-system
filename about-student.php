...
$edit_id = $_SESSION['hidden_student_profile_box'];
...
if ($row > 0) {
	...
	$first_name = mysqli_real_escape_string($con, $fetch_record['firstname']);
	$last_name = mysqli_real_escape_string($con, $fetch_record['lastname']);
	$email = mysqli_real_escape_string($con, $fetch_record['email']);
	$registration_date = mysqli_real_escape_string($con, $fetch_record['registration_date']);
	// $roll_no_id = mysqli_real_escape_string($con, $fetch_record['id']);
	$class = mysqli_real_escape_string($con, $fetch_record['class']);
	$gender = mysqli_real_escape_string($con, $fetch_record['gender']);
	$mobile_number = mysqli_real_escape_string($con, $fetch_record['mobile_number']);
	$parents_name = mysqli_real_escape_string($con, $fetch_record['parents_name']);
	$parents_mobile_number = mysqli_real_escape_string($con, $fetch_record['parents_mobile_number']);
	$date_of_birth = mysqli_real_escape_string($con, $fetch_record['date_of_birth']);
	$address = mysqli_real_escape_string($con, $fetch_record['adress']);
								...
								<div class="card">
									<div class="text-center p-3 overlay-box" style="background-image: url(images/big/img1.jpg);">
										<div class="profile-photo">
											<img src="./uploads/<?php echo $image ?>" width="100" class="img-fluid rounded-circle" alt="">
										</div>
										<h3 class="mt-3 mb-1 text-white"><?php echo $first_name.' '.$last_name ?></h3>
									</div>
									...
									<div class="card-body pb-0">
										...
										<ul class="list-group list-group-flush">
											<li class="list-group-item d-flex px-0 justify-content-between">
												...
												<span class="mb-0"><?php echo $gender ?></span>
											</li>
											<li class="list-group-item d-flex px-0 justify-content-between">
												<strong>Class</strong>
												<span class="mb-0"><?php echo $class ?></span>
											</li>
											<li class="list-group-item d-flex px-0 justify-content-between">
												<strong>Email</strong>
												<span class="mb-0"><?php echo $email ?></span>
											</li>
											<li class="list-group-item d-flex px-0 justify-content-between">
												<strong>Phone</strong>
												<span class="mb-0"><?php echo $mobile_number ?></span>
											</li>
										</ul>
									</div>
                                            ...
                                            <div id="about-me" class="tab-pane fade active show">
                                                <div class="profile-personal-info pt-4">
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span><?php echo $first_name.' '.$last_name ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                                        ...
                                                        <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span><?php echo $email ?></span>
                                                        </div>
                                                    </div>
													<div class="row mb-4">
                                                        <div class="col-lg-3 col-md-4 col-sm-6 col-6">

												...
												<tbody>
													...
													?>
															<tr>
																...
																<td>
																	<a href="teachers-profile.php?id=<?php echo $fetch_record['id']; ?>" class="edit btn btn-sm btn-success"><i class="la la-user"></i></a>
																</td>
												...
												<div class="card card-profile mt-2 ">
													...
													<div class="card-body ">
														<div class="text-center">
															...
															<p class="text-muted"><?php echo $fetch_record['department'] ?> </p>
															<ul class="list-group mb-3 list-group-flush">
																...
																<li class="list-group-item px-0 d-flex justify-content-between">
																	<span class="mb-0">Department:</span><strong><?php echo $fetch_record['department'] ?></strong>
																</li>
															</ul>
															<a class="btn btn-outline-primary btn-rounded mt-3 px-4" href="teachers-profile.php?id=<?php echo $fetch_record['id']; ?>">Read More</a>

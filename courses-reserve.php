                        ...
                        <div class="row">
                            ...
                            if ($query_row > 0) {
                                while ($fetched_record = mysqli_fetch_assoc($query_result)) {
                                    $fetched_course_name = $fetched_record['course_name'];
                                    $fetched_professor_name = $fetched_record['professor_name'];
                                    $fetched_image = $fetched_record['image'];
                            ?>
                                    <div class="col-lg-4 col-md-6">
                                        <div class="singel-course mt-30">
                                            <div class="thum">
                                                <div class="image">
                                                    <img width="460" height="300" src="uploads/<?php echo $fetched_image ?>" alt="Course">
                                                </div>
                                                <div class="price">
                                                    <span>Free</span>
                                                </div>
                                            ...
                                            <div class="cont">
                                                ...
                                                <span>(20 Reviws)</span>
                                                <a href="#">
                                                    <h4>Learn basis <?php echo $fetched_course_name ?> from start for beginner</h4>
                                                </a>
                                                <div class="course-teacher">
                                                    <div class="thum">
                                                        <a href="#"><img src="uploads/<?php echo $fetched_image ?>" alt="teacher"></a>
                                                    </div>
                                                    <div class="name">
                                                        <a href="#">
                                                            <h6><?php echo $fetched_professor_name ?></h6>
                                                        </a>
                                                    </div>
                                                    <div class="admin">
                                                        <ul>

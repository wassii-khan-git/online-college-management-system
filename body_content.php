...
// session_start();
// $library_count =  $_SESSION['library_count'];
// $course_count = $_SESSION['course_count'];
// $professor_count = $_SESSION['professor_count'];
// $student_count = $_SESSION['student_count'];
...
$query_row = mysqli_num_rows($query_res);
$_SESSION['student_count'] =  $query_row;

// for library count
$query = "SELECT * FROM library";
$query_res = mysqli_query($con , $query);
$query_row = mysqli_num_rows($query_res);
$_SESSION['library_count'] =  $query_row;

// for library count
$query = "SELECT * FROM professors";
$query_res = mysqli_query($con , $query);
$query_row = mysqli_num_rows($query_res);
$_SESSION['professor_count'] =  $query_row;

// for library count
$query = "SELECT * FROM courses";
$query_res = mysqli_query($con , $query);
$query_row = mysqli_num_rows($query_res);
$_SESSION['course_count'] =  $query_row;
        ...
        <div class="row">
            <div class="col-xl-3 col-xxl-3 col-sm-6">
                <div class="widget-stat card bg-primary overflow-hidden">
                    <div class="card-header">
                        ...
                        <h5 class="text-white mb-0">'.$_SESSION['student_count'].'</h5>
                    </div>
            ...
            <div class="col-xl-3 col-xxl-3 col-sm-6">
                <div class="widget-stat card bg-success overflow-hidden">
                    <div class="card-header">
                        ...
                        <h5 class="text-white mb-0">'.$_SESSION['library_count'].'</h5>
                    </div>
            ...
            <div class="col-xl-3 col-xxl-3 col-sm-6">
                <div class="widget-stat card bg-secondary overflow-hidden">
                    <div class="card-header pb-3">
                        ...
                        <h5 class="text-white mb-0">'.$_SESSION['course_count'].'</h5>
                    </div>
                    <div class="card-body text-center mt-4 p-0">
            ...
            <div class="col-xl-3 col-xxl-3 col-sm-6">
                <div class="widget-stat card bg-danger overflow-hidden">
                    <div class="card-header pb-3">
                        <h3 class="card-title text-white">Professors</h3>
                        <h5 class="text-white mb-0">'.$_SESSION['professor_count'].'</h5>
                    </div>
                    <div class="card-body p-0 mt-1">
                        <span class="peity-line-2" data-width="100%">7,6,8,7,3,8,3,3,6,5,9,2,8</span>
                    </div>
        ...
        <div class="row">
             <div class="col-xl-3 col-xxl-3 col-sm-6">
                <div class="widget-stat card bg-primary overflow-hidden">
                    <div class="card-header">
                        <h3 class="card-title text-white">Total Students</h3>
                        <h5 class="text-white mb-0"><i class="fa fa-caret-up"></i>'.$_SESSION['student_count'].'</h5>
                    </div>
                    <div class="card-body text-center mt-3">
                        <div class="ico-sparkline">
                            <div id="sparkline12"></div>
            ...
            <div class="col-xl-3 col-xxl-3 col-sm-6">
                <div class="widget-stat card bg-success overflow-hidden">
                    <div class="card-header">
                        <h3 class="card-title text-white">Total Books</h3>
                        <h5 class="text-white mb-0"><i class="fa fa-caret-up"></i>'.$_SESSION['library_count'].'</h5>
                    </div>
                    <div class="card-body text-center mt-4 p-0">
                        <div class="ico-sparkline">
                            <div id="spark-bar-2"></div>
            ...
            <div class="col-xl-3 col-xxl-3 col-sm-6">
                <div class="widget-stat card bg-secondary overflow-hidden">
                    <div class="card-header pb-3">
                        <h3 class="card-title text-white">Total Course</h3>
                        <h5 class="text-white mb-0"><i class="fa fa-caret-up"></i> '.$_SESSION['course_count'].'</h5>
                    </div>
                    <div class="card-body p-0 mt-1">
                        <span class="peity-line-2" data-width="100%">7,6,8,7,3,8,3,3,6,5,9,2,8</span>
                    </div>
            ...
            <div class="col-xl-3 col-xxl-3 col-sm-6">
                <div class="widget-stat card bg-danger overflow-hidden">
                    <div class="card-header pb-3">
                        <h3 class="card-title text-white">Professors</h3>
                        <h5 class="text-white mb-0"><i class="fa fa-caret-up"></i> '.$_SESSION['professor_count'].'</h5>
                    </div>
                    <div class="card-body p-0 mt-1">
                        <span class="peity-line-2" data-width="100%">7,6,8,7,3,8,3,3,6,5,9,2,8</span>
                    </div>

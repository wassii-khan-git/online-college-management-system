...
require_once "./admin/admin-login.php";
...
$retrieve_query = "SELECT * FROM `admin` WHERE `id` = '$profile_id' ";
							...
							<div class="col-lg-12">
								<div class="card">
									<div class="text-center p-3 overlay-box" style="background-image: url(images/big/img1.jpg);">
										...
										<h3 class="mt-3 mb-1 text-white"><?php echo $fetched_username ?></h3>
										<!-- <p class="text-white mb-0"><?php ?></p> -->
									</div>
                                            ...
                                            <div id="about-me" class="tab-pane fade active show">
                                                ...
                                                <div class="profile-personal-info">
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span><?php echo $fetched_username ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <div class="col-lg-3 col-md-4 col-sm-6 col-6">
